...
// Initialize Firebase
var config = {
    apiKey: "AIzaSyBOq8MaNwY7L2xdbxXXBDA8QMZl67_7nKU",
    authDomain: "fir-connect-97fbd.firebaseapp.com",
    databaseURL: "https://fir-connect-97fbd.firebaseio.com",
    projectId: "fir-connect-97fbd",
    storageBucket: "fir-connect-97fbd.appspot.com",
    messagingSenderId: "271482025160"
};
//Here we are referencing config and config is what we need to connect to firebase (not actually run it).
